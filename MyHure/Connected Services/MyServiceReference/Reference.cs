...
namespace MyServiceReference
{
    ...
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName= "MyServiceReference.IStdntAvg")]
    public interface IStdntAvg
    {
        ...
        MyServiceReference.getNameResponse getName(MyServiceReference.getNameRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStdntAvg/getName", ReplyAction="http://tempuri.org/IStdntAvg/getNameResponse")]
        System.Threading.Tasks.Task<MyServiceReference.getNameResponse> getNameAsync(MyServiceReference.getNameRequest request);
        ...
        MyServiceReference.getResultResponse getResult(MyServiceReference.getResultRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStdntAvg/getResult", ReplyAction="http://tempuri.org/IStdntAvg/getResultResponse")]
        System.Threading.Tasks.Task<MyServiceReference.getResultResponse> getResultAsync(MyServiceReference.getResultRequest request);
        ...
        MyServiceReference.getMaxResponse getMax(MyServiceReference.getMaxRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStdntAvg/getMax", ReplyAction="http://tempuri.org/IStdntAvg/getMaxResponse")]
        System.Threading.Tasks.Task<MyServiceReference.getMaxResponse> getMaxAsync(MyServiceReference.getMaxRequest request);
        ...
        MyServiceReference.sortResponse sort(MyServiceReference.sortRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IStdntAvg/sort", ReplyAction="http://tempuri.org/IStdntAvg/sortResponse")]
        System.Threading.Tasks.Task<MyServiceReference.sortResponse> sortAsync(MyServiceReference.sortRequest request);
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public interface IStdntAvgChannel : MyServiceReference.IStdntAvg, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    public partial class StdntAvgClient : System.ServiceModel.ClientBase<MyServiceReference.IStdntAvg>, MyServiceReference.IStdntAvg
    {
        ...
        public MyServiceReference.getNameResponse getName(MyServiceReference.getNameRequest request)
        {
            return base.Channel.getName(request);
        }
        
        public System.Threading.Tasks.Task<MyServiceReference.getNameResponse> getNameAsync(MyServiceReference.getNameRequest request)
        {
            return base.Channel.getNameAsync(request);
        }
        
        public MyServiceReference.getResultResponse getResult(MyServiceReference.getResultRequest request)
        {
            return base.Channel.getResult(request);
        }
        
        public System.Threading.Tasks.Task<MyServiceReference.getResultResponse> getResultAsync(MyServiceReference.getResultRequest request)
        {
            return base.Channel.getResultAsync(request);
        }
        
        public MyServiceReference.getMaxResponse getMax(MyServiceReference.getMaxRequest request)
        {
            return base.Channel.getMax(request);
        }
        
        public System.Threading.Tasks.Task<MyServiceReference.getMaxResponse> getMaxAsync(MyServiceReference.getMaxRequest request)
        {
            return base.Channel.getMaxAsync(request);
        }
        
        public MyServiceReference.sortResponse sort(MyServiceReference.sortRequest request)
        {
            return base.Channel.sort(request);
        }
        
        public System.Threading.Tasks.Task<MyServiceReference.sortResponse> sortAsync(MyServiceReference.sortRequest request)
        {
